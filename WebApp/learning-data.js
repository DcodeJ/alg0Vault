...
window.VAULT_LEARNING = {
  ...
  "items": [
    ...
    },
    {
      ...
      "group": "Objects & OOP",
      "week": 6,
      "markdown": "## In plain English\n\nA value type containing named constants backed by an integral type.\n\n## Why you use it\n\nExpress a small set of named states more clearly than magic numbers.\n\n## Small example\n\n```csharp\nenum OrderStatus { Draft, Submitted, Shipped, Cancelled }\n```\n\nExamples are small fragments; declarations may belong inside a class, and SQL/HTTP examples are shown as comments.\n\n## Common mistake\n\nEnums do not enforce legal state transitions and can contain unnamed numeric values.\n\n## Check your understanding\n\nCan using an enum alone prevent a cancelled order from being submitted?"
    },
    {
